...
export const demoData = {
  ...
  members: [
    ...
    },
    {
      ...
      favoriteGameIds: ['game-mtg'],
      contactMethods: [],
      joinedAt: '2026-07-28T19:10:00+02:00',
    },
    {
      id: 'member-elena-suspended',
      communityId,
      displayName: 'Elena Ferragut',
      initials: 'EF',
      role: 'player',
      status: 'suspended',
      tagIds: ['tag-draft'],
      favoriteGameIds: ['game-mtg'],
      contactMethods: [],
      joinedAt: '2025-09-11T18:30:00+02:00',
    },
  ...
  events: [
    ...
    },
    {
      ...
      title: 'FNM Standard',
      description:
        'Friday Night Magic en formato Standard, con tres rondas fijas.',
    ...
    {
      id: 'event-mtg-draft-express',
      communityId,
      gameId: 'game-mtg',
      formatId: 'format-mtg-draft',
      competitionEventKindId: 'event-kind-draft-night',
      countsForCommunityRanking: true,
      type: 'draft',
      title: 'Draft express MTG',
      description: 'Draft en mesa reducida para cuatro jugadores.',
      startsAt: '2026-08-06T18:00:00+02:00',
      endsAt: '2026-08-06T21:30:00+02:00',
    ...
    },
    {
      ...
      countsForCommunityRanking: true,
      type: 'draft',
      title: 'Draft Night MTG',
      description: 'Draft MTG con una mesa completa de ocho jugadores.',
      startsAt: '2026-08-07T18:00:00+02:00',
      endsAt: '2026-08-07T22:00:00+02:00',
      registrationEnabled: true,
      capacity: 8,
      status: 'scheduled',
      tagIds: ['tag-draft'],
    ...
    {
      id: 'event-result-win-a-box-standard-2026-08-02',
      communityId,
      gameId: 'game-mtg',
      formatId: 'format-mtg-standard',
    ...
    {
      id: 'event-result-fnm-standard-2026-07-24',
      communityId,
      gameId: 'game-mtg',
      formatId: 'format-mtg-standard',
      competitionEventKindId: 'event-kind-fnm',
      ...
      type: 'tournament',
      title: 'FNM Standard',
      description: 'Friday Night Magic Standard con tres rondas fijas.',
    ...
    {
      id: 'event-result-fnm-standard-2026-07-17',
      communityId,
      gameId: 'game-mtg',
      formatId: 'format-mtg-standard',
      competitionEventKindId: 'event-kind-fnm',
    ...
    {
      id: 'event-result-fnm-standard-2026-07-10',
      communityId,
      gameId: 'game-mtg',
      formatId: 'format-mtg-standard',
      competitionEventKindId: 'event-kind-fnm',
    ...
    {
      id: 'event-result-fnm-standard-2026-06-26',
      communityId,
      gameId: 'game-mtg',
      formatId: 'format-mtg-standard',
      competitionEventKindId: 'event-kind-fnm',
    ...
    {
      id: 'event-result-fnm-standard-2026-05-29',
      communityId,
      gameId: 'game-mtg',
      formatId: 'format-mtg-standard',
      competitionEventKindId: 'event-kind-fnm',
    ...
    {
      id: 'event-result-fnm-standard-2025-11-28',
      communityId,
      gameId: 'game-mtg',
      formatId: 'format-mtg-standard',
      competitionEventKindId: 'event-kind-fnm',
  ...
  eventStandings: [
    {
      id: 'standing-win-a-box-standard-2026-08-02',
      eventId: 'event-result-win-a-box-standard-2026-08-02',
    ...
    {
      id: 'standing-fnm-standard-2026-07-24',
      eventId: 'event-result-fnm-standard-2026-07-24',
      entries: buildStanding(
        [
          'member-sergio',
          'member-carla',
    ...
    {
      id: 'standing-fnm-standard-2026-07-17',
      eventId: 'event-result-fnm-standard-2026-07-17',
      entries: buildStanding([
        'member-nora',
        'member-biel',
        'member-sergio',
    ...
    {
      id: 'standing-fnm-standard-2026-07-10',
      eventId: 'event-result-fnm-standard-2026-07-10',
      entries: buildStanding([
        'member-biel',
        'member-carla',
        'member-sergio',
    ...
    {
      id: 'standing-fnm-standard-2026-06-26',
      eventId: 'event-result-fnm-standard-2026-06-26',
      entries: buildStanding([
        'member-carla',
        'member-nora',
        'member-sergio',
    ...
    {
      id: 'standing-fnm-standard-2026-05-29',
      eventId: 'event-result-fnm-standard-2026-05-29',
      entries: buildStanding([
        'member-sergio',
        'member-biel',
        'member-carla',
    ...
    {
      id: 'standing-fnm-standard-2025-11-28',
      eventId: 'event-result-fnm-standard-2025-11-28',
      entries: buildStanding([
        'member-biel',
        'member-sergio',
        'member-carla',
  ...
  registrations: [
    ...
    {
      id: 'registration-irene-draft-express',
      eventId: 'event-mtg-draft-express',
      memberId: 'member-irene',
      status: 'confirmed',
    ...
    {
      id: 'registration-alex-draft-express',
      eventId: 'event-mtg-draft-express',
      memberId: 'member-alex',
      status: 'waitlisted',
      registeredAt: '2026-07-28T10:30:00+02:00',
    },
    {
