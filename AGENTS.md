...
- Conserver les masters d’insignias dans `.local-assets/badges/`, ignoré par Git, et n’ajouter dans `public/badges/` que des PNG optimisés en 192 × 192 pour leur affichage entre 56 et 72 px, et dans `public/badges/large/` un WebP sans perte (`cwebp -lossless -exact`) en 640 × 640 pour la popin d’agrandissement.
